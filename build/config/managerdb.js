...
class ManagerDB {
    static executeQuery(sql, parameters, res) {
        return __awaiter(this, void 0, void 0, function* () {
            // pool.one(sql, parameters).then(ing => res.json({
            //     'nombre': ing.nombres,
            //     'apeliidos': ing.apellidos,
            //     'cedula': ing.identificacion,
            //     'resol': ing.resolucion_nacional,
            // }));
                    ...
                    connectiondb_1.default.one(query, parametros1).then(titulo => {
                        function uniConsulta(query2, parametros2) {
                            connectiondb_1.default.one(query2, parametros2).then(uni => {
                                ...
                                function generateCertif(dataCallback, endCallback) {
                                ...
                                generateCertif((chunk) => stream.write(chunk), () => stream.end());
                            });
                        }
